...
import { TourOperatorComponent } from 'app/entities/tour-operator/tour-operator.component';
...
describe('Component Tests', () => {
  describe('TourOperator Management Component', () => {
    let comp: TourOperatorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TourOperatorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tourOperators[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
