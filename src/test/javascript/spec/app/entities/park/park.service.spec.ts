...
describe('Service Tests', () => {
  describe('Park Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ParkService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Park(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Park', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            location: 'BBBBBB'
