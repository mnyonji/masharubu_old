package ke.co.marvelsoft.masharubu.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ke.co.marvelsoft.masharubu.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ke.co.marvelsoft.masharubu.repository.UserRepository.USERS_BY_EMAIL_CACHE);
