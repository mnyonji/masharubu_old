...
/**
 * REST controller for managing {@link ke.co.marvelsoft.masharubu.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<List<CountryDTO>> getAllCountries(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
